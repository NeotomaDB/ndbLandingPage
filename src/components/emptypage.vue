<template>
  <div>
    <div class="headerbox">
      ...
      <p>This page is intended to operate as a resource for obtaining extended metadata about Neotoma resources and to serve as a platform for DOI landing pages.  To access information about an individual Neotoma Dataset include the dataset ID in the URL: <strong>https://data.neotomadb.org/{DatasetID}</strong>, for example, the dataset for the Lake Tulane Loss on Ignition dataset can be found at <a href="https://data.neotomadb.org/2662">https://data.neotomadb.org/2662</a>.</p> <p><strong>NOTE:</strong> This page is informational and will not directly lead to datasets.  To explore Neotoma datasets interactively please use the <a href="https://apps.neotomadb.org/Explorer">Neotoma Explorer</a>.</p>
